...
void test_comment_wrapped_markdown_block() {
    std::cout << "Testing comment-wrapped markdown block..." << std::endl;
...
```*/
    ...
    std::cout << "Comment-wrapped markdown block test passed!" << std::endl;
}

void test_comment_wrapped_markdown_block_with_name() {
    std::cout << "Testing comment-wrapped markdown block with name..." << std::endl;
...
```*/
    ...
    std::string content(tokens[0].lexeme);
    assert(content.find("mydocs") != std::string::npos);

    std::cout << "Comment-wrapped markdown block with name test passed!" << std::endl;
}
...
int main() {
    ...
    test_comment_wrapped_markdown_block();
    test_comment_wrapped_markdown_block_with_name();
