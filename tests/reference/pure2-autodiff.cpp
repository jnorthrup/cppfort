...
#line 195 "pure2-autodiff.cpp2"
class ad_test_reverse;

#line 261 "pure2-autodiff.cpp2"
}
...
#line 149 "pure2-autodiff.cpp2"
      for( ; cpp2::impl::cmp_less(i,2); (i += 1) ) {
        t = y;
        r.value() = r.value() + t;
      }
}
#line 150 "pure2-autodiff.cpp2"
        return std::move(r.value()); 
