...
// This file provides local test coverage until the parser supports these features
...
// Covers: mixed-hello, pure2-print, pure2-function-single-expression-body-default-return
std::vector<TestCase> basic_function_tests() {
    return {
        {"function_basic_return", 
         "name: () -> std::string = { return \"hello\"; }",
         true, "Basic function with return type"},
         
        {"function_single_expression",
         "square: (x: int) -> int = x * x;",
         true, "Single expression function body"},
         
        {"function_with_inout",
         "decorate: (inout s: std::string) = { s = \"[\" + s + \"]\"; }",
         true, "Function with inout parameter"},
         
        {"function_forward_param",
         "forward_test: (forward x) = { }",
         true, "Function with forward parameter"},
         
        {"function_copy_param",
         "copy_test: (copy x: int) = { }",
         true, "Function with copy parameter"},
         
        {"function_move_param",
         "move_test: (move x: std::string) = { }",
         true, "Function with move parameter"},
         
        {"function_out_param",
         "init: (out result: int) = { result = 42; }",
         true, "Function with out parameter"},
         
        {"main_function",
         "main: () = { }",
         true, "Main function definition"},
         
        {"main_with_args",
         "main: (args) = { }",
         true, "Main with args parameter"},
...
std::vector<TestCase> variable_declaration_tests() {
    return {
        {"var_basic_init",
         "main: () = { x: int = 42; }",
         true, "Basic variable with initialization"},
         
        {"var_type_deduction",
         "main: () = { x := 42; }",
         true, "Variable with type deduction"},
        ...
        {"var_pointer",
         "main: () = { p: *int = nullptr; }",
         true, "Pointer variable"},
         
        {"var_const_pointer",
         "main: () = { p: const *int = nullptr; }",
         true, "Const pointer variable"},
         
        {"var_pointer_const",
         "main: () = { p: *const int = nullptr; }",
         true, "Pointer to const variable"},
         
        {"var_reference",
         "main: () = { x: int = 42; r: *int = x&; }",
         true, "Reference variable"},
        ...
        {"var_multiple",
         "main: () = { x: int = 1; y: int = 2; z: int = x + y; }",
         true, "Multiple variables"},
    };
}

// --- Category: Control Flow ---
// Covers: pure2-break-continue, pure2-intro-example-three-loops, mixed-intro-example-three-loops
std::vector<TestCase> control_flow_tests() {
    return {
        {"if_basic",
         "main: () = { x: int = 5; if x > 0 { } }",
         true, "Basic if statement"},
         
        {"if_else",
         "main: () = { x: int = 5; if x > 0 { } else { } }",
        ...
        {"while_loop",
         "main: () = { x: int = 0; while x < 10 { x = x + 1; } }",
         true, "While loop"},
         
        {"do_while",
         "main: () = { x: int = 0; do { x = x + 1; } while x < 10; }",
         true, "Do-while loop"},
         
        {"for_range",
         "main: () = { for 0 ..< 10 do (i) { } }",
         true, "For loop with range"},
         
        {"for_range_inclusive",
         "main: () = { for 0 ..= 10 do (i) { } }",
         true, "For loop with inclusive range"},
         
        {"break_in_loop",
         "main: () = { while true { break; } }",
         true, "Break in loop"},
         
        {"continue_in_loop",
         "main: () = { x: int = 0; while x < 10 { x = x + 1; if x == 5 { continue; } } }",
         true, "Continue in loop"},
         
        {"next_in_loop",
         "main: () = { for 0 ..< 10 do (i) { if i == 5 { next; } } }",
         true, "Next in for loop"},
    };
}
...
std::vector<TestCase> contract_tests() {
    return {
        ...
        {"assert_with_message",
         "main: () = { assert(1 == 1, \"math works\"); }",
         true, "Assert with message"},
         
        {"pre_condition",
         "positive: (x: int) pre(x > 0) = { }",
         true, "Pre-condition"},
         
        {"post_condition",
         "abs: (x: int) -> int post($ >= 0) = { if x < 0 { return -x; } return x; }",
         true, "Post-condition"},
         
        {"pre_post_combined",
         "clamp: (x: int, lo: int, hi: int) -> int pre(lo <= hi) post($ >= lo) post($ <= hi) = { if x < lo { return lo; } if x > hi { return hi; } return x; }",
         true, "Combined pre and post conditions"},
    };
}

// --- Category: Inspect/Pattern Matching ---
// Covers: pure2-inspect-values, mixed-inspect-values, pure2-inspect-expression-in-generic-function-multiple-types
std::vector<TestCase> inspect_tests() {
    return {
        {"inspect_basic",
         "classify: (x: int) -> std::string = inspect x -> std::string { is 0 = \"zero\"; is _ = \"other\"; };",
         true, "Basic inspect expression"},
         
        // Guard syntax not yet supported - expected to fail
        {"inspect_with_guard",
         "classify: (x: int) -> std::string = inspect x -> std::string { is (< 0) = \"negative\"; is 0 = \"zero\"; is _ = \"positive\"; };",
         false, "Inspect with guard - not yet supported"},
         
        {"is_type_check",
         "main: () = { x: int = 42; if x is int { } }",
         true, "Is type check"},
         
        {"as_cast",
         "main: () = { x: int = 42; y := x as long; }",
         true, "As type cast"},
    };
}

// --- Category: Types/Classes ---
// Covers: pure2-types-basics, pure2-types-inheritance, pure2-types-order-independence-and-nesting
std::vector<TestCase> type_tests() {
    return {
        {"type_basic",
         "Point: type = { x: int = 0; y: int = 0; }",
         true, "Basic type definition"},
         
        {"type_with_method",
         "Point: type = { x: int = 0; y: int = 0; magnitude: (this) -> double = 0.0; }",
         true, "Type with method"},
         
        {"type_constructor",
         "Point: type = { x: int = 0; y: int = 0; operator=: (out this, _x: int, _y: int) = { x = _x; y = _y; } }",
         true, "Type with constructor"},
         
        {"type_destructor",
         "Resource: type = { data: int = 0; operator=: (move this) = { } }",
         true, "Type with destructor"},
         
        {"type_this_param",
         "Counter: type = { value: int = 0; increment: (inout this) = { value = value + 1; } }",
         true, "Type with this parameter"},
         
        {"type_virtual",
         "Base: type = { f: (virtual this) = { } }",
         true, "Type with virtual method"},
         
        {"type_override",
         "Derived: type = { f: (override this) = { } }",
         true, "Type with override method"},
...
std::vector<TestCase> namespace_tests() {
    return {
        {"namespace_basic",
         "N: namespace = { f: () = { } }",
         true, "Basic namespace"},
         
        {"namespace_nested",
         "A: namespace = { B: namespace = { f: () = { } } }",
         true, "Nested namespace"},
         
        {"namespace_alias",
         "N: namespace = { f: () = { } }\nmyns: namespace == N;",
         true, "Namespace alias"},
    };
}

// --- Category: String Interpolation ---
// Covers: pure2-interpolation, mixed-string-interpolation, pure2-raw-string-literal-and-interpolation
std::vector<TestCase> string_interpolation_tests() {
    return {
        {"interpolation_basic",
         "main: () = { x: int = 42; s := \"value is (x)$\"; }",
         true, "Basic string interpolation"},
         
        {"interpolation_expression",
         "main: () = { x: int = 42; s := \"double is (x * 2)$\"; }",
         true, "String interpolation with expression"},
...
// --- Category: UFCS ---
// Covers: pure2-ufcs-member-access-and-chaining, mixed-bugfix-for-ufcs-non-local
std::vector<TestCase> ufcs_tests() {
    return {
        {"ufcs_basic",
         "main: () = { v: std::vector<int> = (); n := v.size(); }",
        ...
        {"ufcs_with_args",
         "main: () = { v: std::vector<int> = (); v.push_back(42); }",
         true, "UFCS with arguments"},
    };
}
...
std::vector<TestCase> range_tests() {
    return {
        {"range_exclusive",
         "main: () = { for 0 ..< 10 do (i) { } }",
         true, "Exclusive range"},
         
        {"range_inclusive",
         "main: () = { for 0 ..= 10 do (i) { } }",
         true, "Inclusive range"},
         
        {"range_in_expression",
         "in_range: (x: int) -> bool = x >= 0 && x < 10;",
...
std::vector<TestCase> template_tests() {
    return {
        {"template_function",
         "identity: <T> (x: T) -> T = x;",
         true, "Template function"},
         
        {"template_multiple_params",
         "pair: <T, U> (a: T, b: U) = { }",
         true, "Template with multiple parameters"},
         
        {"requires_clause",
         "numeric: <T> (x: T) -> T requires std::is_arithmetic_v<T> = x;",
         true, "Function with requires clause"},
    };
}
...
// --- Category: Operators ---
// Covers: pure2-chained-comparisons, mixed-increment-decrement, pure2-defaulted-comparisons-and-final-types
std::vector<TestCase> operator_tests() {
    return {
        {"operator_comparison",
         "main: () = { x: int = 5; b := x > 0 && x < 10; }",
         true, "Comparison operators"},
         
        {"operator_arithmetic",
         "main: () = { x: int = 5; y := x + 1 * 2 - 3 / 1; }",
         true, "Arithmetic operators"},
         
        {"operator_increment",
         "main: () = { x: int = 5; x++; }",
         true, "Increment operator"},
         
        {"operator_decrement",
         "main: () = { x: int = 5; x--; }",
         true, "Decrement operator"},
         
        {"operator_prefix_increment",
         "main: () = { x: int = 5; ++x; }",
         true, "Prefix increment operator"},
         
        {"operator_address",
         "main: () = { x: int = 5; p := x&; }",
         true, "Address-of operator"},
         
        {"operator_dereference",
         "main: () = { x: int = 5; p := x&; y := p*; }",
         true, "Dereference operator"},
    };
}

// --- Category: Capture ---
// Covers: mixed-captures-in-expressions-and-postconditions, mixed-postexpression-with-capture
std::vector<TestCase> capture_tests() {
    return {
        ...
        {"capture_in_postcondition",
         "save: (x: int) -> int post($ == x$) = x;",
...
std::vector<TestCase> default_argument_tests() {
    return {
        {"default_arg_basic",
         "greet: (name: std::string = \"world\") = { }",
         true, "Function with default argument"},
         
        {"default_arg_multiple",
         "point: (x: int = 0, y: int = 0) = { }",
         true, "Multiple default arguments"},
    };
}
...
std::vector<TestCase> unsafe_tests() {
    return {
        {"unsafe_block",
         "main: () = { unchecked { p: *int = nullptr; _ = p; } }",
...
std::vector<TestCase> union_tests() {
    return {
        {"union_basic",
         "MyUnion: @union type = { i: int; f: float; }",
         true, "Basic union"},
    };
}
...
// Covers: pure2-forward-return, pure2-forward-return-diagnostics-error, mixed-forwarding
std::vector<TestCase> forward_return_tests() {
    return {
        {"forward_return",
         "identity: (forward x) -> forward _ = x;",
         true, "Forward return"},
         
        {"multiple_returns",
         "divmod: (a: int, b: int) -> (quot: int, rem: int) = { return (a / b, a % b); }",
         true, "Multiple return values"},
    };
}

// --- Category: Metafunctions ---
// Covers: pure2-enum, pure2-union, pure2-types-value-types-via-meta-functions, pure2-types-ordering-via-meta-functions
std::vector<TestCase> metafunction_tests() {
    return {
        {"enum_metafunction",
         "Color: @enum type = { red; green; blue; }",
         true, "Enum metafunction"},
         
        {"enum_with_values",
         "Status: @enum type = { ok := 0; error := 1; pending := 2; }",
         true, "Enum with explicit values"},
         
        {"flag_enum_metafunction",
         "Flags: @flag_enum type = { read; write; execute; }",
         true, "Flag enum metafunction"},
         
        {"struct_metafunction",
         "Point: @struct type = { x: int; y: int; }",
         true, "Struct metafunction"},
         
        {"interface_metafunction",
         "Drawable: @interface type = { draw: (this); }",
         true, "Interface metafunction"},
         
        {"polymorphic_base_metafunction",
         "Animal: @polymorphic_base type = { speak: (virtual this); }",
         true, "Polymorphic base metafunction"},
    };
}
...
std::vector<TestCase> labeled_control_tests() {
    return {
        {"labeled_while",
         "main: () = { i := 0; outer: while i < 3 { i++; } }",
         true, "Labeled while loop"},
         
        {"labeled_for",
         "main: () = { outer: for 0 ..< 10 do (i) { } }",
         true, "Labeled for loop"},
         
        {"break_labeled",
         "main: () = { i := 0; outer: while true { break outer; } }",
         true, "Break with label"},
...
std::vector<TestCase> statement_scope_tests() {
    return {
        {"statement_scope_copy",
         "main: () = { x := 42; (copy y := x) { y++; } }",
         true, "Statement scope with copy"},
         
        {"statement_scope_inout",
         "main: () = { x := 42; (inout y := x) { y++; } }",
         true, "Statement scope with inout"},
         
        {"statement_scope_in_for",
         "main: () = { x := 42; (i := x) for 0 ..< 3 do (j) { } }",
         true, "Statement scope in for loop"},
         
        {"statement_scope_in_while",
         "main: () = { x := 42; (i := x) while i > 0 { } }",
         true, "Statement scope in while loop"},
    };
}
...
std::vector<TestCase> trailing_comma_tests() {
    return {
        {"trailing_comma_params",
         "f: (a: int, b: int,) = { }",
         true, "Trailing comma in parameters"},
         
        {"trailing_comma_args",
         "main: () = { f(1, 2,); }\nf: (a: int, b: int) = { }",
         true, "Trailing comma in arguments"},
         
        {"trailing_comma_template",
         "f: <T, U,> (a: T, b: U) = { }",
         true, "Trailing comma in template params"},
    };
}
...
std::vector<TestCase> concept_tests() {
    return {
        ...
        // Note: requires expression in concept is complex and not yet fully supported
        {"concept_with_constraint",
         "addable: <T> concept = requires(a: T, b: T) { a + b; };",
         true, "Concept with requires expression - complex"},
    };
}
...
std::vector<TestCase> variadic_tests() {
    return {
        ...
        {"variadic_function",
         "print_all: <Args...: type> (args...: Args) = { }",
         true, "Variadic function"},
         
        {"fold_expression",
         "sum: <Args...: type> (args...: Args) -> _ = (... + args);",
         true, "Fold expression"},
    };
}
...
std::vector<TestCase> constraint_tests() {
    return {
        {"type_constraint_basic",
         "f: <T: type> (x: T) requires std::is_integral_v<T> = { }",
         true, "Basic type constraint"},
         
        {"multiline_requires",
         "X: <T: type, U: type> type requires std::is_same_v<T, int> && std::is_same_v<U, int> = { }",
         true, "Multiline requires clause"},
         
        {"value_requires",
         "f: (x) -> int requires true == x;",
         true, "Value requires clause"},
    };
}
...
std::vector<TestCase> reflection_tests() {
    return {
        {"print_metafunction",
         "outer: @print type = { f: () = { } }",
         true, "Print metafunction"},
         
        {"protected_member",
         "C: type = { protected f: () = { } }",
         true, "Protected member"},
...
std::vector<TestCase> inheritance_tests() {
    return {
        {"base_type",
         "Base: type = { f: (virtual this) = { } }",
         true, "Base type with virtual"},
         
        {"derived_type",
         "Derived: type = { f: (override this) = { } }",
         true, "Derived type with override"},
        ...
        {"implicit_constructor",
         "C: type = { operator=: (implicit out this, x: int) = { } }",
         true, "Implicit constructor"},
         
        {"multiple_bases",
         "Cyborg: type = { this: Human = (); this: Machine = (); }",
...
std::vector<TestCase> smart_pointer_tests() {
    return {
        {"unique_new",
         "main: () = { p := unique.new<int>(42); }",
         true, "unique.new syntax"},
         
        {"shared_new",
         "main: () = { p := shared.new<int>(42); }",
         true, "shared.new syntax"},
    };
}
...
std::vector<TestCase> chained_comparison_tests() {
    return {
        {"chained_equals",
         "main: () = { i := 1; j := 1; k := 1; b := i == j == k; }",
         true, "Chained equality"},
         
        {"chained_less",
         "main: () = { i := 1; j := 2; k := 3; b := i < j < k; }",
         true, "Chained less than"},
         
        {"chained_mixed",
         "main: () = { i := 1; j := 2; k := 2; b := i < j <= k; }",
         true, "Chained mixed comparisons"},
    };
}

// --- Category: Inspect with Types ---
// Covers: pure2-inspect-expression-in-generic-function-multiple-types, pure2-inspect-fallback-with-variant-any-optional
std::vector<TestCase> inspect_type_tests() {
    return {
        {"inspect_variant",
         "test: (x: _) -> std::string = inspect x -> std::string { is int = \"int\"; is _ = \"other\"; };",
         true, "Inspect with variant"},
         
        {"is_check_in_if",
         "main: () = { x := 42; if x is int { } }",
         true, "Is check in if"},
         
        {"as_conversion",
         "main: () = { x := 42; s := x as std::string; }",
         true, "As conversion"},
    };
}

// --- Category: Bounds Safety ---
// Covers: pure2-bounds-safety-span, mixed-bounds-check, mixed-bounds-safety-with-assert
std::vector<TestCase> bounds_safety_tests() {
    return {
        {"assert_bounds",
         "main: () = { assert<bounds_safety>(true); }",
         true, "Bounds safety assert"},
         
        {"type_safety_assert",
         "main: () = { assert<type_safety>(true); }",
         true, "Type safety assert"},
    };
}

// --- Category: Initializer Safety ---
// Covers: mixed-initialization-safety-3, pure2-initialization-safety-with-else-if
std::vector<TestCase> init_safety_tests() {
    return {
        {"definite_init_if",
         "main: () = { x: int; if true { x = 1; } else { x = 2; } _ = x; }",
         true, "Definite init in if-else"},
         
        {"definite_init_else_if",
         "main: () = { x: int; if true { x = 1; } else if false { x = 2; } else { x = 3; } _ = x; }",
         true, "Definite init in else-if"},
    };
}

// --- Category: Type Deduction ---
// Covers: pure2-function-typeids, pure2-function-single-expression-body-default-return
std::vector<TestCase> type_deduction_tests() {
    return {
        {"auto_return",
         "f: () -> _ = 42;",
         true, "Auto return type"},
         
        {"inferred_param",
         "f: (x: _) = { }",
         true, "Inferred parameter type"},
         
        {"single_expr_return",
         "square: (x: int) -> int = x * x;",
         true, "Single expression return"},
    };
}

// --- Category: Function Expressions ---
// Covers: mixed-function-expression-and-std-for-each, mixed-function-expression-with-pointer-capture
std::vector<TestCase> function_expression_tests() {
    return {
        ...
        {"lambda_with_params",
         "main: () = { f := :(a: int, b: int) = a + b; }",
         true, "Lambda with params"},
         
        {"lambda_returning",
         "main: () = { f := :() -> int = 42; }",
         true, "Lambda with return type"},
    };
}
...
std::vector<TestCase> ufcs_edge_tests() {
    return {
        {"ufcs_template_args",
         "main: () = { v: std::vector<int> = (); n := v.size(); }",
         true, "UFCS with template args"},
    };
}

// --- Category: Lifetime Safety ---
// Covers: mixed-lifetime-safety-and-null-contracts, mixed-lifetime-safety-pointer-init-4
std::vector<TestCase> lifetime_safety_tests() {
    return {
        {"null_check_contract",
         "f: (p: *int) pre(p != nullptr) = { }",
         true, "Null check in contract"},
    };
}

// --- Category: Parameter Passing Modes ---
// Covers: mixed-parameter-passing, mixed-parameter-passing-with-forward, mixed-parameter-passing-generic-out
...
std::vector<TestCase> using_tests() {
    return {
        {"using_namespace",
         "main: () = { using std::cout; }",
         true, "Using declaration"},
         
        {"using_wildcard",
         "main: () = { using std::_; }",
         true, "Using with wildcard"},
    };
}
...
std::vector<TestCase> alias_complex_tests() {
    return {
        {"template_alias",
         "IntVec: type == std::vector<int>;",
         true, "Template type alias"},
         
        {"nested_alias",
         "N: namespace = { T: type == int; }",
         true, "Nested type alias"},
    };
}
...
std::vector<TestCase> object_alias_tests() {
    return {
        {"object_alias",
         "PI: double == 3.14159;",
         true, "Object alias constant"},
         
        {"template_object_alias",
         "zero: <T> T == 0;",
         true, "Template object alias"},
    };
}
...
std::vector<TestCase> break_continue_tests() {
    return {
        {"labeled_while_with_next",
         "f: () = { i := 0; while i < 3 next i++ { } }",
         true, "While loop with next clause"},
         
        {"labeled_inner_loop",
         "f: () = { i := 0; while i < 3 next i++ { j := 0; inner: while j < 3 next j++ { } } }",
         true, "Labeled inner while loop"},
         
        {"continue_inner_label",
         "f: () = { i := 0; inner: while i < 3 next i++ { if i == 1 { continue inner; } } }",
         true, "Continue with inner label"},
         
        {"break_outer_label",
         "f: () = { outer: while true { j := 0; while j < 3 next j++ { if j == 1 { break outer; } } } }",
         true, "Break with outer label"},
         
        {"do_while_with_next",
         "f: () = { i := 0; do { } next i++ while i < 3; }",
         true, "Do-while with next clause"},
         
        {"labeled_do_while",
         "f: () = { i := 0; outer: do { j := 0; do { } next j++ while j < 3; } next i++ while i < 3; }",
        ...
        {"continue_outer_for",
         "f: () = { vi: std::vector = (0, 1, 2); outer: for vi do (i) { vj: std::vector = (0, 1, 2); for vj do (j) { if j == 1 { continue outer; } } } }",
...
std::vector<TestCase> contracts_extended_tests() {
    return {
        ...
        {"assert_with_unevaluated",
         "main: () = { assert<unevaluated>(any.kind(of, nonsense)); }",
         true, "Assert with unevaluated group"},
        ...
        {"pre_with_bounds_safety",
         "first: (forward rng) pre<bounds_safety>(!std::empty(rng)) = std::begin(rng)*;",
...
std::vector<TestCase> types_basics_tests() {
    return {
        {"implicit_constructor",
         "myclass: type = { operator=: (implicit out this, x: int) = { } }",
         true, "Type with implicit constructor"},
         
        {"explicit_string_constructor",
         "myclass: type = { operator=: (out this, s: std::string) = { } }",
         true, "Type with string constructor"},
        ...
        {"move_print_method",
         "myclass: type = { print: (move this) = { } }",
         true, "Type with move this method"},
         
        {"type_with_default_values",
         "myclass: type = { data: int = 42 * 12; more: std::string = std::to_string(42); }",
         true, "Type with default member values"},
         
        {"nested_type",
         "myclass: type = { nested: type = { g: () = { } } }",
         true, "Nested type definition"},
         
        {"type_template_methods",
         "myclass: type = { f1: <T, U> (t: T, u: U) = t + u; f2: <T: type, U: type> (t: T, u: U) = t + u; }",
...
std::vector<TestCase> types_inheritance_tests() {
    return {
        {"interface_metafunction",
         "Human: @interface type = { speak: (this); }",
        ...
        {"multiple_base_classes",
         "Cyborg: type = { name: std::string; this: Human = (); address: std::string = \"123 Main St.\"; this: Machine<99>; }",
         true, "Type with multiple bases"},
         
        {"override_method",
         "Derived: type = { speak: (override this) = { } }",
         true, "Override method"},
         
        {"vcall_function",
         "make_speak: (h: Human) = { h.speak(); }",
         true, "Virtual call through base"},
    };
}
...
std::vector<TestCase> enum_extended_tests() {
    return {
        {"enum_with_explicit_value",
         "skat_game: @enum type = { diamonds := 9; hearts; spades; clubs; grand := 20; null := 23; }",
        ...
        {"flag_enum_with_type",
         "file_attributes: @flag_enum<u8> type = { cached; current; obsolete; cached_and_current := cached | current; }",
         true, "Flag enum with underlying type"},
         
        {"enum_methods",
         "main: () = { x: skat_game = skat_game::clubs; _ = x.to_string(); _ = skat_game::from_string(\"hearts\"); }",
...
std::vector<TestCase> variadics_extended_tests() {
    return {
        {"type_pack_expansion",
         "x: <Ts...: type> type = { tup: std::tuple<Ts...> = (); }",
         true, "Type with variadic pack expansion"},
         
        {"int_pack_expansion",
         "y: <Ts...: int> type = { func: () = (0 + ... + Ts); }",
         true, "Type with int variadic pack"},
         
        {"discard_type_pack",
         "t0: @struct <_...> type = { f: <_: int> () -> i32 = 0; }",
         true, "Struct with discarded type pack"},
         
        {"left_fold_expression",
         "left_fold_print: <Args...: type> (inout out: std::ostream, args...: Args) = { (out << ... << args); }",
         true, "Left fold expression"},
         
        {"unary_fold_expression",
         "all: <Args...: type> (args...: Args) -> bool = (... && args);",
         true, "Unary fold expression"},
         
        {"make_with_variadics",
         "make: <T, Args...> (forward args...: Args) = :T = args...;",
         true, "Make function with variadics"},
         
        {"instantiate_variadic_type",
         "main: () = { _: x<int, long, std::string> = (); }",
         true, "Instantiate variadic type"},
    };
}
...
std::vector<TestCase> requires_extended_tests() {
    return {
        ...
        {"variable_with_requires",
         ...
         true, "Variable template with requires"},
    };
}
...
std::vector<TestCase> ufcs_extended_tests() {
    return {
        {"ufcs_on_literal",
         "main: () = { res := (42).ufcs(); }",
         true, "UFCS on literal"},
         
        {"ufcs_no_return",
         "main: () = { 42.no_return(); }",
         true, "UFCS with no return"},
         
        {"explicit_non_ufcs",
         "main: () = { obj: mytype = (); obj..hun(42); }",
        ...
        {"chained_ufcs_with_returns",
         "main: () = { _ = fun().ufcs(); }",
         true, "Chained UFCS on function return"},
    };
}
...
std::vector<TestCase> inspect_extended_tests() {
    return {
        {"inspect_variant",
         "main: () = { v: std::variant<int, int, double> = 42.0; }",
         true, "Variant declaration"},
         
        {"inspect_any",
         "main: () = { a: std::any = \"xyzzy\" as std::string; }",
         true, "Any declaration with as cast"},
         
        {"inspect_optional",
         "main: () = { o: std::optional<int> = (); }",
         true, "Optional declaration"},
...
std::vector<TestCase> last_use_tests() {
    return {
        ...
        {"forward_lambda",
         "main: () = { l1 := :(forward x) = { f_inout(forward x); }; }",
         true, "Forward in lambda"},
         
        {"statement_scope_copy",
         "main: () = { (copy x := new<int>(0)) f_copy(move x); }",
         true, "Statement scope with copy"},
         
        {"closure_return",
         "issue_850: () = { v: std::vector = (1, 2, 3); f := :() -> forward_ref _ = { return v$; }; }",
...
std::vector<TestCase> smf_tests() {
    return {
        {"copy_constructor",
         "T: type = { operator=: (out this, that) = { } }",
         true, "Copy constructor with that"},
         
        {"move_constructor",
         "T: type = { operator=: (out this, move that) = { } }",
         true, "Move constructor with move that"},
         
        {"copy_assign",
         "T: type = { operator=: (inout this, that) = { } }",
         true, "Copy assignment with that"},
         
        {"move_assign",
         "T: type = { operator=: (inout this, move that) = { } }",
         true, "Move assignment with move that"},
         
        {"destructor",
         "T: type = { operator=: (move this) = { } }",
         true, "Destructor with move this"},
         
        {"comparisons",
         "T: type = { operator<=>: (this, that) -> std::strong_ordering; operator==: (this, that) -> bool; }",
         true, "Comparison operators"},
    };
}
...
// Covers: pure2-various-string-literals, pure2-raw-string-literal-and-interpolation
std::vector<TestCase> string_features_tests() {
    return {
        {"raw_string_literal",
         "main: () = { s := R\"delim(raw string)delim\"; }",
         true, "Raw string literal"},
         
        {"multiline_raw_string",
         "main: () = { s := R\"(line1\nline2)\"; }",
         true, "Multiline raw string"},
...
std::vector<TestCase> forward_return_tests_extended() {
    return {
        {"forward_return_with_pre",
         "first: (forward rng) -> forward _ pre<bounds_safety>(!std::empty(rng)) = std::begin(rng)*;",
...
std::vector<TestCase> assert_not_null_tests() {
    return {
        {"assert_unique_ptr",
         "main: () = { p := unique.new<int>(42); assert(p != nullptr); }",
         true, "Assert unique_ptr not null"},
         
        {"assert_shared_ptr",
         "main: () = { p := shared.new<int>(42); assert(p != nullptr); }",
         true, "Assert shared_ptr not null"},
        ...
        {"assert_expected",
         "main: () = { e: std::expected<int, std::string> = 42; assert(e.has_value()); }",
...
std::vector<TestCase> bugfix_tests() {
    return {
        {"indexed_call",
         "main: () = { v: std::vector<int> = (); n := v[0]; }",
         true, "Indexed access"},
         
        {"discard_precedence",
         "main: () = { _ = f(); }",
         true, "Discard with function call"},
         
        {"template_argument",
         "main: () = { v: std::vector<int> = (); }",
         true, "Template argument"},
        ...
        {"max_munch",
         "main: () = { x := 1; y := 2; z := x + +y; }",
         true, "Max munch with operators"},
         
        {"variable_template",
         "v: <T> T = 0;",
         true, "Variable template"},
    };
}
...
std::vector<TestCase> value_type_tests() {
    return {
        {"value_type",
         ...
         true, "Value type metafunction"},
         
        {"ordered_type",
         "Priority: @ordered type = { level: int = 0; }",
         true, "Ordered type metafunction"},
...
std::vector<TestCase> regex_feature_tests() {
    return {
        {"regex_declaration",
         "main: () = { pattern := std::regex(\"hello\"); }",
         true, "Regex declaration"},
         
        {"regex_match",
         "main: () = { s := \"hello\"; if std::regex_match(s, std::regex(\"h.*\")) { } }",
         true, "Regex match"},
    };
}
...
std::vector<TestCase> concept_extended_tests() {
    return {
        ...
        {"assert_with_concept",
         "main: () = { assert<testing>(arithmetic<i32>); }",
         true, "Assert with concept"},
    };
}
...
std::vector<TestCase> hashable_tests() {
    return {
        {"hashable_type",
         "Point: @hashable type = { x: int = 0; y: int = 0; }",
...
std::vector<TestCase> bounds_safety_extended_tests() {
    return {
        {"span_declaration",
         "main: () = { arr: std::array<int, 3> = (1, 2, 3); s: std::span<int> = arr; }",
...
std::vector<TestCase> synthesized_operator_tests() {
    return {
        {"right_shift",
         "main: () = { x: int = 16; y := x >> 2; }",
         true, "Right shift operator"},
         
        {"right_shift_eq",
         "main: () = { x: int = 16; x >>= 2; }",
         true, "Right shift assign operator"},
    };
}
...
int main() {
    ...
    auto run_category = [](const std::string& name, const std::vector<TestCase>& tests) {
        std::cout << "--- " << name << " ---\n";
    ...
    // Actual regression file tests - test full/partial files from cppfront test suite
