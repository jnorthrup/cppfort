...
#line 1 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"

#line 48 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
class mytype;
...
#line 29 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
...
#line 35 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
[[nodiscard]] auto fun() -> fun_ret;

#line 40 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
[[nodiscard]] auto get_i(auto const& r) -> int;

#line 44 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
...
#line 50 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
};
...
#line 1 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
[[nodiscard]] auto main() -> int{
#line 2 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
    auto i {42}; 
...
#line 31 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
[[nodiscard]] auto ufcs(cpp2::impl::in<int> i) -> int{
    return i + 2; 
}
...
#line 36 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
    i.construct(42);
...
#line 45 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
[[nodiscard]] auto f([[maybe_unused]] auto const& unnamed_param_1) -> int { return 0;  }
int y {CPP2_UFCS_NONLOCAL(f)(0)}; 

#line 49 "third_party/cppfront/regression-tests/pure2-ufcs-member-access-and-chaining.cpp2"
