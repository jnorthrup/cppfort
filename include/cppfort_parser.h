...
public:
    ...
    void set_source(std::string source) { source_storage_ = std::move(source); }
    std::string_view source() const { return source_storage_; }
...
private:
    ...
    std::unique_ptr<ASTNode> parse_join_expression();
