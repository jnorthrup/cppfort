# Story: Implement capture analysis for lambdas
...
I want Implement capture analysis for lambdas,
...
- [ ] Implementation complete for Implement capture analysis for lambdas
