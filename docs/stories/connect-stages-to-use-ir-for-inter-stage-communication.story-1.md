# Story: Connect stages to use IR for inter-stage communication
...
I want Connect stages to use IR for inter-stage communication,
...
Based on current architecture (swimlane: stage1), this enhancement builds on existing infrastructure.
The system uses a three-stage pipeline (Stage0/Stage1/Stage2) with Sea of Nodes IR.

### Integration Approach

- Work within existing framework in src/stage1/
...
- src/stage1/*.cpp - Core implementation
- include/stage1/*.h - Headers
- regression-tests/*.sh - Test harness

## Tasks / Subtasks

- [ ] Task 1: Analyze current implementation
  - [ ] Review existing code in src/stage1/
...
- [ ] Implementation complete for Connect stages to use IR for inter-stage communication
