# Story: Implement GCM (Global Code Motion) optimization pass
...
I want Implement GCM (Global Code Motion) optimization pass,
...
- [ ] Implementation complete for Implement GCM (Global Code Motion) optimization pass
