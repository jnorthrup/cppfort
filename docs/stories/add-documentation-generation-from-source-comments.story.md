# Story: Add documentation generation from source comments
...
I want Add documentation generation from source comments,
...
Based on current architecture (swimlane: docs), this enhancement builds on existing infrastructure.
The system uses a three-stage pipeline (Stage0/Stage1/Stage2) with Sea of Nodes IR.

### Integration Approach

- Work within existing framework in src/docs/
...
- src/docs/*.cpp - Core implementation
- include/docs/*.h - Headers
- regression-tests/*.sh - Test harness

## Tasks / Subtasks

- [ ] Task 1: Analyze current implementation
  - [ ] Review existing code in src/docs/
...
- [ ] Implementation complete for Add documentation generation from source comments
