...
flowchart TD
    ...
    Parser["PARSER (selfhost rbcursive.cpp2 via cppfront)<br/>━━━━━━━━━━━━━━━━━━━━━━<br/>Feature-Stream Scanning → Pure cpp2 bootstrap parsing → Smoke gate<br/>(rbcursive.cpp2) → (selfhost surface) → (ctest)"]
