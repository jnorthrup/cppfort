...
/Users/jim/work/cppfort/micro-tests/results/arithmetic/ar050-bit-clear/ar050-bit-clear_O0.out:	file format mach-o arm64
...
10000037c: 0a290100    	bic	w0, w8, w9
...
100000398: 52801fe0    	mov	w0, #0xff               ; =255
10000039c: 52800061    	mov	w1, #0x3                ; =3
1000003a0: 97fffff0    	bl	0x100000360 <__Z14test_bit_clearii>
