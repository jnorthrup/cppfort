...
/Users/jim/work/cppfort/micro-tests/results/arithmetic/ar051-bit-toggle/ar051-bit-toggle_O0.out:	file format mach-o arm64
...
10000037c: 4a090100    	eor	w0, w8, w9
...
10000039c: 52800021    	mov	w1, #0x1                ; =1
1000003a0: 97fffff0    	bl	0x100000360 <__Z15test_bit_toggleii>
