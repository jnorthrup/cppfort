...
/Users/jim/work/cppfort/micro-tests/results/arithmetic/ar012-compound-add/ar012-compound-add_O0.out:	file format mach-o arm64

Disassembly of section __TEXT,__text:

0000000100000360 <__Z17test_compound_addii>:
...
10000039c: 528000a1    	mov	w1, #0x5                ; =5
1000003a0: 97fffff0    	bl	0x100000360 <__Z17test_compound_addii>
