...
/Users/jim/work/cppfort/micro-tests/results/classes/cls051-inherit/cls051-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800680    	mov	w0, #0x34               ; =52
...
100000520: 52800660    	mov	w0, #0x33               ; =51
