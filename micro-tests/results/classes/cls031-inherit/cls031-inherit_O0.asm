...
/Users/jim/work/cppfort/micro-tests/results/classes/cls031-inherit/cls031-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800400    	mov	w0, #0x20               ; =32
...
100000520: 528003e0    	mov	w0, #0x1f               ; =31
