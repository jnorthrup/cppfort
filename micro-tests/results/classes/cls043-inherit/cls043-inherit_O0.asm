...
/Users/jim/work/cppfort/micro-tests/results/classes/cls043-inherit/cls043-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800580    	mov	w0, #0x2c               ; =44
...
100000520: 52800560    	mov	w0, #0x2b               ; =43
