...
/Users/jim/work/cppfort/micro-tests/results/classes/cls059-inherit/cls059-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800780    	mov	w0, #0x3c               ; =60
...
100000520: 52800760    	mov	w0, #0x3b               ; =59
