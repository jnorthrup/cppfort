...
/Users/jim/work/cppfort/micro-tests/results/classes/cls046-inherit/cls046-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 528005e0    	mov	w0, #0x2f               ; =47
...
100000520: 528005c0    	mov	w0, #0x2e               ; =46
