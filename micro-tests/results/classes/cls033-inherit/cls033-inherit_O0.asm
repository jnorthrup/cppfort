...
/Users/jim/work/cppfort/micro-tests/results/classes/cls033-inherit/cls033-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800440    	mov	w0, #0x22               ; =34
...
100000520: 52800420    	mov	w0, #0x21               ; =33
