...
/Users/jim/work/cppfort/micro-tests/results/classes/cls053-inherit/cls053-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 528006c0    	mov	w0, #0x36               ; =54
...
100000520: 528006a0    	mov	w0, #0x35               ; =53
