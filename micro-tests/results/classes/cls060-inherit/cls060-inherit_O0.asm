...
/Users/jim/work/cppfort/micro-tests/results/classes/cls060-inherit/cls060-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 528007a0    	mov	w0, #0x3d               ; =61
...
100000520: 52800780    	mov	w0, #0x3c               ; =60
