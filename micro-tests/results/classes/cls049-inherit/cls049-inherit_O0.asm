...
/Users/jim/work/cppfort/micro-tests/results/classes/cls049-inherit/cls049-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800640    	mov	w0, #0x32               ; =50
...
100000520: 52800620    	mov	w0, #0x31               ; =49
