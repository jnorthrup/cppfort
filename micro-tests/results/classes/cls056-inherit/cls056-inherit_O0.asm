...
/Users/jim/work/cppfort/micro-tests/results/classes/cls056-inherit/cls056-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800720    	mov	w0, #0x39               ; =57
...
100000520: 52800700    	mov	w0, #0x38               ; =56
