...
/Users/jim/work/cppfort/micro-tests/results/classes/cls055-inherit/cls055-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800700    	mov	w0, #0x38               ; =56
...
100000520: 528006e0    	mov	w0, #0x37               ; =55
