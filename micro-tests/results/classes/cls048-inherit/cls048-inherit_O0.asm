...
/Users/jim/work/cppfort/micro-tests/results/classes/cls048-inherit/cls048-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800620    	mov	w0, #0x31               ; =49
...
100000520: 52800600    	mov	w0, #0x30               ; =48
