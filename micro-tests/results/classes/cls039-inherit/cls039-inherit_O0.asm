...
/Users/jim/work/cppfort/micro-tests/results/classes/cls039-inherit/cls039-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800500    	mov	w0, #0x28               ; =40
...
100000520: 528004e0    	mov	w0, #0x27               ; =39
