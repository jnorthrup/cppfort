...
/Users/jim/work/cppfort/micro-tests/results/classes/cls050-inherit/cls050-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800660    	mov	w0, #0x33               ; =51
...
100000520: 52800640    	mov	w0, #0x32               ; =50
