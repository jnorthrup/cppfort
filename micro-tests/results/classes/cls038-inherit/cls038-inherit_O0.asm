...
/Users/jim/work/cppfort/micro-tests/results/classes/cls038-inherit/cls038-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 528004e0    	mov	w0, #0x27               ; =39
...
100000520: 528004c0    	mov	w0, #0x26               ; =38
