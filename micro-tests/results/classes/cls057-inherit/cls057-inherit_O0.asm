...
/Users/jim/work/cppfort/micro-tests/results/classes/cls057-inherit/cls057-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800740    	mov	w0, #0x3a               ; =58
...
100000520: 52800720    	mov	w0, #0x39               ; =57
