...
/Users/jim/work/cppfort/micro-tests/results/classes/cls045-inherit/cls045-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 528005c0    	mov	w0, #0x2e               ; =46
...
100000520: 528005a0    	mov	w0, #0x2d               ; =45
