...
/Users/jim/work/cppfort/micro-tests/results/classes/cls058-inherit/cls058-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800760    	mov	w0, #0x3b               ; =59
...
100000520: 52800740    	mov	w0, #0x3a               ; =58
