...
/Users/jim/work/cppfort/micro-tests/results/classes/cls035-inherit/cls035-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800480    	mov	w0, #0x24               ; =36
...
100000520: 52800460    	mov	w0, #0x23               ; =35
