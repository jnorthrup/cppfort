...
/Users/jim/work/cppfort/micro-tests/results/classes/cls041-inherit/cls041-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800540    	mov	w0, #0x2a               ; =42
...
100000520: 52800520    	mov	w0, #0x29               ; =41
