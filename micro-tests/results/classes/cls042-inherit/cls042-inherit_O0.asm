...
/Users/jim/work/cppfort/micro-tests/results/classes/cls042-inherit/cls042-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800560    	mov	w0, #0x2b               ; =43
...
100000520: 52800540    	mov	w0, #0x2a               ; =42
