...
/Users/jim/work/cppfort/micro-tests/results/classes/cls032-inherit/cls032-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800420    	mov	w0, #0x21               ; =33
...
100000520: 52800400    	mov	w0, #0x20               ; =32
