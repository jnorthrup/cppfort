...
/Users/jim/work/cppfort/micro-tests/results/classes/cls047-inherit/cls047-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800600    	mov	w0, #0x30               ; =48
...
100000520: 528005e0    	mov	w0, #0x2f               ; =47
