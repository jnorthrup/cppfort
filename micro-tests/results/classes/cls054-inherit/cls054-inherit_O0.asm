...
/Users/jim/work/cppfort/micro-tests/results/classes/cls054-inherit/cls054-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 528006e0    	mov	w0, #0x37               ; =55
...
100000520: 528006c0    	mov	w0, #0x36               ; =54
