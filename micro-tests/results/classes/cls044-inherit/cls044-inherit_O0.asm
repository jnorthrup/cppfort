...
/Users/jim/work/cppfort/micro-tests/results/classes/cls044-inherit/cls044-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 528005a0    	mov	w0, #0x2d               ; =45
...
100000520: 52800580    	mov	w0, #0x2c               ; =44
