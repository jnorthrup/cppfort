...
/Users/jim/work/cppfort/micro-tests/results/classes/cls040-inherit/cls040-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800520    	mov	w0, #0x29               ; =41
...
100000520: 52800500    	mov	w0, #0x28               ; =40
