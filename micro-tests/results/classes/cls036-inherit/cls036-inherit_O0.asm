...
/Users/jim/work/cppfort/micro-tests/results/classes/cls036-inherit/cls036-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 528004a0    	mov	w0, #0x25               ; =37
...
100000520: 52800480    	mov	w0, #0x24               ; =36
