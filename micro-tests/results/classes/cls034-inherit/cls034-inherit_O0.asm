...
/Users/jim/work/cppfort/micro-tests/results/classes/cls034-inherit/cls034-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 52800460    	mov	w0, #0x23               ; =35
...
100000520: 52800440    	mov	w0, #0x22               ; =34
