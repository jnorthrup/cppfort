...
/Users/jim/work/cppfort/micro-tests/results/classes/cls037-inherit/cls037-inherit_O0.out:	file format mach-o arm64
...
1000004ac: 528004c0    	mov	w0, #0x26               ; =38
...
100000520: 528004a0    	mov	w0, #0x25               ; =37
