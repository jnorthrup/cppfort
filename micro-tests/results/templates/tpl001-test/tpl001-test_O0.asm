...
/Users/jim/work/cppfort/micro-tests/results/templates/tpl001-test/tpl001-test_O0.out:	file format mach-o arm64
...
100000458: 52800021    	mov	w1, #0x1                ; =1
10000045c: aa0103e0    	mov	x0, x1
