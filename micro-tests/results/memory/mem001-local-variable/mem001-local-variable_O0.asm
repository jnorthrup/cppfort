...
/Users/jim/work/cppfort/micro-tests/results/memory/mem001-local-variable/mem001-local-variable_O0.out:	file format mach-o arm64
...
100000388: 97fffff6    	bl	0x100000360 <__Z19test_local_variablev>
