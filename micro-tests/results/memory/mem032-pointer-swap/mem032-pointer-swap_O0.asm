...
/Users/jim/work/cppfort/micro-tests/results/memory/mem032-pointer-swap/mem032-pointer-swap_O0.out:	file format mach-o arm64
...
1000003c4: 97ffffe7    	bl	0x100000360 <__Z4swapPiS_>
