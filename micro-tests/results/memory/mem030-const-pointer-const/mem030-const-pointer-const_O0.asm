...
/Users/jim/work/cppfort/micro-tests/results/memory/mem030-const-pointer-const/mem030-const-pointer-const_O0.out:	file format mach-o arm64
...
100000394: 97fffff3    	bl	0x100000360 <__Z24test_const_pointer_constv>
