...
/Users/jim/work/cppfort/micro-tests/results/memory/mem016-pointer-basic/mem016-pointer-basic_O0.out:	file format mach-o arm64
...
100000394: 97fffff3    	bl	0x100000360 <__Z18test_pointer_basicv>
