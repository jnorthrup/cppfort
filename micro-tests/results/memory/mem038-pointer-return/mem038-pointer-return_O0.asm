...
/Users/jim/work/cppfort/micro-tests/results/memory/mem038-pointer-return/mem038-pointer-return_O0.out:	file format mach-o arm64
...
100000414: 97fffff9    	bl	0x1000003f8 <__Z11get_pointerv>
