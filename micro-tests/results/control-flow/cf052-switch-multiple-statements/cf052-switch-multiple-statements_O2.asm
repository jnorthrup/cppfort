...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf052-switch-multiple-statements/cf052-switch-multiple-statements_O2.out:	file format mach-o arm64
