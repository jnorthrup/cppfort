...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf068-goto-error-handling/cf068-goto-error-handling_O3.out:	file format mach-o arm64
...
100000374: 1a8a816a    	csel	w10, w11, w10, hi
