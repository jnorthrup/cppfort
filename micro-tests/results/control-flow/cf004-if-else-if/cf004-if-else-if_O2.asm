...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf004-if-else-if/cf004-if-else-if_O2.out:	file format mach-o arm64
...
10000036c: 1a893529    	cinc	w9, w9, hs
