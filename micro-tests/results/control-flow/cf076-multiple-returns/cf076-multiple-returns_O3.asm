...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf076-multiple-returns/cf076-multiple-returns_O3.out:	file format mach-o arm64
...
100000370: 1a8a354a    	cinc	w10, w10, hs
