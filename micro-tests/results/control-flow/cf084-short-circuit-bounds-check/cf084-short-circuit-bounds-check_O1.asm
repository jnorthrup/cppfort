...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf084-short-circuit-bounds-check/cf084-short-circuit-bounds-check_O1.out:	file format mach-o arm64
