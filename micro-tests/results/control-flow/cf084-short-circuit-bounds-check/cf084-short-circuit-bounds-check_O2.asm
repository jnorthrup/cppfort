...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf084-short-circuit-bounds-check/cf084-short-circuit-bounds-check_O2.out:	file format mach-o arm64
