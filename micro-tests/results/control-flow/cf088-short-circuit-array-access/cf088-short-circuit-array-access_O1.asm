...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf088-short-circuit-array-access/cf088-short-circuit-array-access_O1.out:	file format mach-o arm64
