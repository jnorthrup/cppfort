...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf089-short-circuit-function-calls/cf089-short-circuit-function-calls_O1.out:	file format mach-o arm64
