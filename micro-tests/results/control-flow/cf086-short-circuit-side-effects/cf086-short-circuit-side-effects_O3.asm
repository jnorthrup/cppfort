...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf086-short-circuit-side-effects/cf086-short-circuit-side-effects_O3.out:	file format mach-o arm64
