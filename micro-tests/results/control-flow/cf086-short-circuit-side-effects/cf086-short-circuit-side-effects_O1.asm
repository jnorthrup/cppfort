...
/Users/jim/work/cppfort/micro-tests/results/control-flow/cf086-short-circuit-side-effects/cf086-short-circuit-side-effects_O1.out:	file format mach-o arm64
