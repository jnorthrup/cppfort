...
/Users/jim/work/cppfort/micro-tests/results/functions/fn056-template/fn056-template_O0.out:	file format mach-o arm64
...
100000458: 52800700    	mov	w0, #0x38               ; =56
...
100000478: 1100e100    	add	w0, w8, #0x38
