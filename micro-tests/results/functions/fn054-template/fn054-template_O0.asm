...
/Users/jim/work/cppfort/micro-tests/results/functions/fn054-template/fn054-template_O0.out:	file format mach-o arm64
...
100000458: 528006c0    	mov	w0, #0x36               ; =54
...
100000478: 1100d900    	add	w0, w8, #0x36
