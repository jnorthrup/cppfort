...
/Users/jim/work/cppfort/micro-tests/results/functions/fn062-lambda/fn062-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 528007c1    	mov	w1, #0x3e               ; =62
...
1000003f4: 1100f900    	add	w0, w8, #0x3e
