...
/Users/jim/work/cppfort/micro-tests/results/functions/fn042-template/fn042-template_O0.out:	file format mach-o arm64
...
100000458: 52800540    	mov	w0, #0x2a               ; =42
...
100000478: 1100a900    	add	w0, w8, #0x2a
