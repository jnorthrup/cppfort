...
/Users/jim/work/cppfort/micro-tests/results/functions/fn049-template/fn049-template_O0.out:	file format mach-o arm64
...
100000458: 52800620    	mov	w0, #0x31               ; =49
...
100000478: 1100c500    	add	w0, w8, #0x31
