...
/Users/jim/work/cppfort/micro-tests/results/functions/fn064-lambda/fn064-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800801    	mov	w1, #0x40               ; =64
...
1000003f4: 11010100    	add	w0, w8, #0x40
