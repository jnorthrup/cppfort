...
/Users/jim/work/cppfort/micro-tests/results/functions/fn046-template/fn046-template_O0.out:	file format mach-o arm64
...
100000458: 528005c0    	mov	w0, #0x2e               ; =46
...
100000478: 1100b900    	add	w0, w8, #0x2e
