...
/Users/jim/work/cppfort/micro-tests/results/functions/fn052-template/fn052-template_O0.out:	file format mach-o arm64
...
100000458: 52800680    	mov	w0, #0x34               ; =52
...
100000478: 1100d100    	add	w0, w8, #0x34
