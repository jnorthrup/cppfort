...
/Users/jim/work/cppfort/micro-tests/results/functions/fn051-template/fn051-template_O0.out:	file format mach-o arm64
...
100000458: 52800660    	mov	w0, #0x33               ; =51
...
100000478: 1100cd00    	add	w0, w8, #0x33
