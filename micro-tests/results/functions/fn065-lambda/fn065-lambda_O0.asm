...
/Users/jim/work/cppfort/micro-tests/results/functions/fn065-lambda/fn065-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800821    	mov	w1, #0x41               ; =65
...
1000003f4: 11010500    	add	w0, w8, #0x41
