...
/Users/jim/work/cppfort/micro-tests/results/functions/fn076-lambda/fn076-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800981    	mov	w1, #0x4c               ; =76
...
1000003f4: 11013100    	add	w0, w8, #0x4c
