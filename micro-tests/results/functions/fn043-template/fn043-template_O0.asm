...
/Users/jim/work/cppfort/micro-tests/results/functions/fn043-template/fn043-template_O0.out:	file format mach-o arm64
...
100000458: 52800560    	mov	w0, #0x2b               ; =43
...
100000478: 1100ad00    	add	w0, w8, #0x2b
