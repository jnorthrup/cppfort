...
/Users/jim/work/cppfort/micro-tests/results/functions/fn045-template/fn045-template_O0.out:	file format mach-o arm64
...
100000458: 528005a0    	mov	w0, #0x2d               ; =45
...
100000478: 1100b500    	add	w0, w8, #0x2d
