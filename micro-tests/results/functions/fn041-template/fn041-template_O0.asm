...
/Users/jim/work/cppfort/micro-tests/results/functions/fn041-template/fn041-template_O0.out:	file format mach-o arm64
...
100000458: 52800520    	mov	w0, #0x29               ; =41
...
100000478: 1100a500    	add	w0, w8, #0x29
