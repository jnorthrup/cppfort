...
/Users/jim/work/cppfort/micro-tests/results/functions/fn080-lambda/fn080-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800a01    	mov	w1, #0x50               ; =80
...
1000003f4: 11014100    	add	w0, w8, #0x50
