...
/Users/jim/work/cppfort/micro-tests/results/functions/fn050-template/fn050-template_O0.out:	file format mach-o arm64
...
100000458: 52800640    	mov	w0, #0x32               ; =50
...
100000478: 1100c900    	add	w0, w8, #0x32
