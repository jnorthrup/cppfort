...
/Users/jim/work/cppfort/micro-tests/results/functions/fn074-lambda/fn074-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800941    	mov	w1, #0x4a               ; =74
...
1000003f4: 11012900    	add	w0, w8, #0x4a
