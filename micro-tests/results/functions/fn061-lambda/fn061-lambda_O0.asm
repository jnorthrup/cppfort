...
/Users/jim/work/cppfort/micro-tests/results/functions/fn061-lambda/fn061-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 528007a1    	mov	w1, #0x3d               ; =61
...
1000003f4: 1100f500    	add	w0, w8, #0x3d
