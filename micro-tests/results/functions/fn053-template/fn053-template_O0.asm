...
/Users/jim/work/cppfort/micro-tests/results/functions/fn053-template/fn053-template_O0.out:	file format mach-o arm64
...
100000458: 528006a0    	mov	w0, #0x35               ; =53
...
100000478: 1100d500    	add	w0, w8, #0x35
