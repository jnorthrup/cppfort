...
/Users/jim/work/cppfort/micro-tests/results/functions/fn060-template/fn060-template_O0.out:	file format mach-o arm64
...
100000458: 52800780    	mov	w0, #0x3c               ; =60
...
100000478: 1100f100    	add	w0, w8, #0x3c
