...
/Users/jim/work/cppfort/micro-tests/results/functions/fn073-lambda/fn073-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800921    	mov	w1, #0x49               ; =73
...
1000003f4: 11012500    	add	w0, w8, #0x49
