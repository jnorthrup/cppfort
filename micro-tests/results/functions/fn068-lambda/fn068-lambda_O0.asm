...
/Users/jim/work/cppfort/micro-tests/results/functions/fn068-lambda/fn068-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800881    	mov	w1, #0x44               ; =68
...
1000003f4: 11011100    	add	w0, w8, #0x44
