...
/Users/jim/work/cppfort/micro-tests/results/functions/fn044-template/fn044-template_O0.out:	file format mach-o arm64
...
100000458: 52800580    	mov	w0, #0x2c               ; =44
...
100000478: 1100b100    	add	w0, w8, #0x2c
