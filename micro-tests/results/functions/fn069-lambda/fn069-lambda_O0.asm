...
/Users/jim/work/cppfort/micro-tests/results/functions/fn069-lambda/fn069-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 528008a1    	mov	w1, #0x45               ; =69
...
1000003f4: 11011500    	add	w0, w8, #0x45
