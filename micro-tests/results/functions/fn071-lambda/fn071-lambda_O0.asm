...
/Users/jim/work/cppfort/micro-tests/results/functions/fn071-lambda/fn071-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 528008e1    	mov	w1, #0x47               ; =71
...
1000003f4: 11011d00    	add	w0, w8, #0x47
