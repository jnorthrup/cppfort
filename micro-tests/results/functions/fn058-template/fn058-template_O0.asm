...
/Users/jim/work/cppfort/micro-tests/results/functions/fn058-template/fn058-template_O0.out:	file format mach-o arm64
...
100000458: 52800740    	mov	w0, #0x3a               ; =58
...
100000478: 1100e900    	add	w0, w8, #0x3a
