...
/Users/jim/work/cppfort/micro-tests/results/functions/fn075-lambda/fn075-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800961    	mov	w1, #0x4b               ; =75
...
1000003f4: 11012d00    	add	w0, w8, #0x4b
