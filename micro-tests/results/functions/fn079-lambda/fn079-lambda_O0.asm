...
/Users/jim/work/cppfort/micro-tests/results/functions/fn079-lambda/fn079-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 528009e1    	mov	w1, #0x4f               ; =79
...
1000003f4: 11013d00    	add	w0, w8, #0x4f
