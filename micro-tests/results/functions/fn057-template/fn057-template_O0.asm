...
/Users/jim/work/cppfort/micro-tests/results/functions/fn057-template/fn057-template_O0.out:	file format mach-o arm64
...
100000458: 52800720    	mov	w0, #0x39               ; =57
...
100000478: 1100e500    	add	w0, w8, #0x39
