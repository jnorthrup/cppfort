...
/Users/jim/work/cppfort/micro-tests/results/functions/fn047-template/fn047-template_O0.out:	file format mach-o arm64
...
100000458: 528005e0    	mov	w0, #0x2f               ; =47
...
100000478: 1100bd00    	add	w0, w8, #0x2f
