...
/Users/jim/work/cppfort/micro-tests/results/functions/fn055-template/fn055-template_O0.out:	file format mach-o arm64
...
100000458: 528006e0    	mov	w0, #0x37               ; =55
...
100000478: 1100dd00    	add	w0, w8, #0x37
