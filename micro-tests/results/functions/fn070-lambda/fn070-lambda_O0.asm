...
/Users/jim/work/cppfort/micro-tests/results/functions/fn070-lambda/fn070-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 528008c1    	mov	w1, #0x46               ; =70
...
1000003f4: 11011900    	add	w0, w8, #0x46
