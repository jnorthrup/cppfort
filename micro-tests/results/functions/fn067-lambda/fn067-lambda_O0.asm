...
/Users/jim/work/cppfort/micro-tests/results/functions/fn067-lambda/fn067-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800861    	mov	w1, #0x43               ; =67
...
1000003f4: 11010d00    	add	w0, w8, #0x43
