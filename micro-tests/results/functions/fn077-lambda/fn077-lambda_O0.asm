...
/Users/jim/work/cppfort/micro-tests/results/functions/fn077-lambda/fn077-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 528009a1    	mov	w1, #0x4d               ; =77
...
1000003f4: 11013500    	add	w0, w8, #0x4d
