...
/Users/jim/work/cppfort/micro-tests/results/functions/fn059-template/fn059-template_O0.out:	file format mach-o arm64
...
100000458: 52800760    	mov	w0, #0x3b               ; =59
...
100000478: 1100ed00    	add	w0, w8, #0x3b
