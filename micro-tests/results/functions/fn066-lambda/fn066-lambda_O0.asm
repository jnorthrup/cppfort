...
/Users/jim/work/cppfort/micro-tests/results/functions/fn066-lambda/fn066-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 52800841    	mov	w1, #0x42               ; =66
...
1000003f4: 11010900    	add	w0, w8, #0x42
