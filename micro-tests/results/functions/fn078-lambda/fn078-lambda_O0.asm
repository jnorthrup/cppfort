...
/Users/jim/work/cppfort/micro-tests/results/functions/fn078-lambda/fn078-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 528009c1    	mov	w1, #0x4e               ; =78
...
1000003f4: 11013900    	add	w0, w8, #0x4e
