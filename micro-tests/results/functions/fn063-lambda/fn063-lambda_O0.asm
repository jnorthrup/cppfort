...
/Users/jim/work/cppfort/micro-tests/results/functions/fn063-lambda/fn063-lambda_O0.out:	file format mach-o arm64
...
1000003d0: 528007e1    	mov	w1, #0x3f               ; =63
...
1000003f4: 1100fd00    	add	w0, w8, #0x3f
