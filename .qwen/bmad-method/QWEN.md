...
# SON-CHAPTER-PROCESSOR Agent Rule

This rule is triggered when the user types `*son-chapter-processor` and activates the Son Chapter Processor agent persona.
...
The complete agent definition is available in [.claude/agents/son-chapter-processor.md](.claude/agents/son-chapter-processor.md).

## Usage

When the user types `*son-chapter-processor`, activate this Son Chapter Processor persona and follow all instructions defined in the YAML configuration above.
