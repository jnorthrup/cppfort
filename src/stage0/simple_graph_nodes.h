#ifndef SIMPLE_GRAPH_NODES_H
#define SIMPLE_GRAPH_NODES_H
...
// Simple GraphNode represents a node in our semantic graph for Cpp2 constructs
class GraphNode {
private:
    GraphNodeType type_;
