...
#line 1 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
...
#line 4 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
auto f() -> void;
...
#line 19 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
// --- Tests for type aliases

using A_h_forward = std::string&(std::string& s);

#line 24 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
auto main() -> int;
...
#line 6 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
auto g_in(      cpp2::impl::in<std::string> s) -> void{std::cout << "Come in, " + cpp2::to_string(s) + "\n";}
#line 7 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
auto g_inout(std::string& s) -> void{std::cout << "Come in awhile, but take some biscuits on your way out, " + cpp2::to_string(s) + "!\n"; }
#line 8 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
auto g_out(cpp2::impl::out<std::string> s) -> void{s.construct("A Powerful Mage");}
#line 9 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
auto g_move(std::string&& s) -> void{std::cout << "I hear you've moving, " + cpp2::to_string(cpp2::move(s)) + "?\n";}

#line 11 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
[[nodiscard]] auto h_forward(std::string& s) -> std::string&{std::cout << "Inout " + cpp2::to_string(s) + " ... "; return s; }
#line 12 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
[[nodiscard]] auto h_out(cpp2::impl::in<std::string> s) -> std::string{std::cout << "In " + cpp2::to_string(s) + " ... ";return "yohoho"; }

#line 14 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
[[nodiscard]] auto f1(cpp2::impl::in<std::function<int(cpp2::impl::in<int> x)>> a) -> int { return a(1);  }
#line 15 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
[[nodiscard]] auto f2(int(*a)(cpp2::impl::in<int> x)) -> int { return a(2); }
#line 16 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
...
#line 37 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
...
#line 76 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
...
#line 97 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
    //  --- Tests for function parameters
    std::cout << "" + cpp2::to_string(f1(&g)) + "\n";
    std::cout << "" + cpp2::to_string(f2(&g)) + "\n";

#line 102 "/var/folders/kd/t4gdhlf137n0zbd6x34z1hcm0000gn/T/tmp.frfkuyRL72/pure2-function-typeids.cpp2"
}
