...
test:auto <M> (regex: M, id: std::string, regex_str: std::string, str: std::string, kind: std::string, resultExpr: std::string,
...
}void test_tests_13_possessive_modifier: @regex type = {
  regex_01 := R"(a++a)";
  regex_02 := R"(a*+a)";
  regex_03 := R"(a{1,5}+a)";
  regex_04 := R"(a?+a)";
  ...
  run(this) { std::cout << "Running tests_13_possessive_modifier:"<< std::endl;
...
int main() { test_tests_13_possessive_modifier().run(); }
