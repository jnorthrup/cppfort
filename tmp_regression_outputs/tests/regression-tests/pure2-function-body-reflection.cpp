...
:test
sample_function_after_type: () // This function will not be visible as a namespace member while reflecting on ns = {}; }

int main() { std::cout << "calling generated function ns::add_1... ns::add_1(42) returned (ns::add_1(42))$\n"; }
